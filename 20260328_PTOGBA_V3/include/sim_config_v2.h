...
// V2.1 新增: 并发资源持有参数
// ============================================================================
// 真实同步操作处理时间 (us 级，而不是 ns 级)
constexpr double BARRIER_PROCESSING_TIME_US = 5.0;    // 5 us
constexpr double BARRIER_PROCESSING_TIME_NS = BARRIER_PROCESSING_TIME_US * 1000.0;

// 批量突发参数
constexpr uint32_t BURST_BATCH_SIZE = 100;            // 每批突发 100 个请求
constexpr double BURST_ARRIVAL_INTERVAL_NS = 100.0;   // 批次间隔 100 ns
